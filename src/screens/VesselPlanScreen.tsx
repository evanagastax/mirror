...
const SPLITS: Record<number, DayTemplate[]> = {
  2: [
    { label: "Full Body A", bodyParts: ["chest", "back", "upper legs"], icon: "💪" },
    { label: "Full Body B", bodyParts: ["shoulders", "upper arms", "waist"], icon: "🏋️" },
  ],
  3: [
    { label: "Push",  bodyParts: ["chest", "shoulders", "upper arms"], icon: "⬆️" },
    { label: "Pull",  bodyParts: ["back", "upper arms", "lower arms"], icon: "⬇️" },
    { label: "Legs",  bodyParts: ["upper legs", "lower legs", "waist"], icon: "🦵" },
  ],
  4: [
    { label: "Chest & Triceps", bodyParts: ["chest", "upper arms"],        icon: "💪" },
    { label: "Back & Biceps",   bodyParts: ["back", "lower arms"],          icon: "🔙" },
    { label: "Legs & Core",     bodyParts: ["upper legs", "lower legs", "waist"], icon: "🦵" },
    { label: "Shoulders & Arms",bodyParts: ["shoulders", "upper arms"],    icon: "🏋️" },
  ],
  5: [
    { label: "Chest",     bodyParts: ["chest"],                       icon: "💪" },
    { label: "Back",      bodyParts: ["back"],                        icon: "🔙" },
    { label: "Legs",      bodyParts: ["upper legs", "lower legs"],    icon: "🦵" },
    { label: "Shoulders", bodyParts: ["shoulders", "upper arms"],     icon: "🏋️" },
    { label: "Core & Cardio", bodyParts: ["waist", "cardio"],         icon: "🫀" },
  ],
  6: [
    { label: "Chest",     bodyParts: ["chest"],                       icon: "💪" },
    { label: "Back",      bodyParts: ["back"],                        icon: "🔙" },
    { label: "Legs",      bodyParts: ["upper legs", "lower legs"],    icon: "🦵" },
    { label: "Shoulders", bodyParts: ["shoulders"],                   icon: "🏋️" },
    { label: "Arms",      bodyParts: ["upper arms", "lower arms"],    icon: "🦾" },
    { label: "Core & Cardio", bodyParts: ["waist", "cardio"],         icon: "🫀" },
  ],
};
