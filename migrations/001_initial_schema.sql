-- =============================================================
-- THE MIRROR — Migration 001: Initial Schema
...
-- Activity logs (soul / vessel / impact entries feed the pillar trigger)
...
-- Financial ledger (stewardship score auto-updates from here)
...
-- Ensures the Compass screen always has a row to fetch on
-- first login — no blank screen on fresh accounts.
-- =============================================================
...
-- Soul / Vessel / Impact scores accumulate from logs.value.
-- =============================================================
...
-- =============================================================
-- 6. TRIGGER: update Stewardship score from transactions
...
begin
  pts := case new.category
    ...
    else 0  -- 'leak' awards nothing (logging it is still the good habit)
  end;
...
-- =============================================================
-- 7. REALTIME
-- Lets the Compass update instantly when a trigger fires,
